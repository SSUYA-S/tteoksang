...
export default function SettingModal(props: settingType) {
    ...
    return (
        <>
            <div
                className="w-full h-full absolute top-0 left-0 z-30 opacity-0"
                onClick={closeResultModal}
            ></div>
            <div
                className="absolute w-[40%] h-[40%] flex items-center justify-start color-text-textcolor border-[0.4vw] color-border-brown1 color-bg-main z-40 rounded-[0.8vw] animation-modal ">
