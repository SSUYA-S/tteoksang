        ...
        <>
            <div className="w-full h-full flex items-center">
                <div className="w-[50%] h-full flex flex-col items-center px-[2vw] py-[1vh]">
                    <p className="w-full text-left text-[1.8vw] my-[0.5vh]">
                        수익
                    </p>
                    <div className="w-full flex justify-between my-[0.5vh] text-[1.4vw]">
                        <p>작물 판매 비용</p>
                        <p>
                    ...
                    <p className="w-full text-left text-[1.8vw] mt-[1.5vh]">
                        지출
                    </p>
                    <div className="w-full flex justify-between my-[0.5vh] text-[1.4vw]">
                        <p>작물 구매 비용</p>
