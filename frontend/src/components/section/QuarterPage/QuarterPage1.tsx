...
export default function QuarterPage1(props: Prop) {
        ...
        <>
            <div className="w-full h-full flex items-center">
                <div className="w-[50%] h-full flex flex-col items-center">
                    {/* 기간표시 */}
                    <div className="w-full h-[10%] text-[1.4vw] flex justify-center items-center">
                        <p>{timeDuration1}</p>
                    </div>
                    {/* 분기 정산 결과 */}
                    <div className="w-full h-[55%] text-[1.4vw] flex flex-col px-[3vw] py-[1vh] justify-between">
                        <div className="w-full">
                            <div className="w-full flex justify-between">
                                <div>수익</div>
                                <div>{props.qtrIncome.toLocaleString()}</div>
                            </div>
                            <div className="w-full flex justify-between">
                                <div>임대료</div>
                                <div>
                                    {(-1 * props.qtrOutcome).toLocaleString()}
                                </div>
                            </div>
                        ...
                        <div className="w-full flex flex-col items-center">
                            ...
                            <div className="w-full flex justify-between">
                                ...
                                <div>
                                    {(
                                        props.qtrIncome - props.qtrOutcome
                                    ).toLocaleString()}
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="w-full h-[35%] flex flex-col items-center">
                        <p className="w-[90%] h-[20%] text-left text-[1.4vw]">
                            현재 칭호
                        </p>
                        <div className="w-[90%] h-[80%] pb-[1vh] flex justify-between items-center">
                            ...
                            <div
                                className="border-[0.2vw] w-[20%] h-[40%] py-[0.2vw] text-[1.5vw] bg-white color-border-subbold text-center cursor-pointer rounded-[0.6vw] hover:color-bg-subbold hover:text-white flex justify-center items-center"
                                onClick={() => {
                                    props.setMode(2);
                                }}
                            >
                ...
                <div className="w-[50%] h-full flex flex-col justify-between">
                    <div className="w-full h-[10%] ml-[1vw] mt-[1vh]">
                        <div className="text-[1.8vw] text-left">
                            {nowSeason}
                        </div>
                    </div>
                    {/* 이벤트 요소 */}
                        ...
                        >
                            <div className="flex h-full">
                                ...
                                <div
                                    ...
                                    ref={cropDescRef}
                                >
                                    <p className="w-full text-left text-[1.4vw]">
                                        {cropName}
                                    </p>
