...
public class PrivateGameController {
    ...
    public GameMessage handlePrivateMessage(@DestinationVariable("webSocketId") String webSocketId,
                                            @Payload GameMessage gameMessage, Principal principal) {
    ...
    */
        ...
        switch (gameMessage.getType()) {
            case CHANGE_TITLE: {
                // 칭호 변경
                LinkedHashMap<String, Object> body = (LinkedHashMap<String, Object>) gameMessage.getBody();
